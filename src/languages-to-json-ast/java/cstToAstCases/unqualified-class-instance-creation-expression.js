...
function run(cstNode, children) {
    ...
    return {
        ...
        children: __spreadArrays([].concat.apply([], (_a = argumentList === null || argumentList === void 0 ? void 0 : argumentList.map(function (e) { return cst_to_ast_1.cstToAst(e); })) !== null && _a !== void 0 ? _a : []), [].concat.apply([], (_b = classOrInterfaceTypeToInstantiate === null || classOrInterfaceTypeToInstantiate === void 0 ? void 0 : classOrInterfaceTypeToInstantiate.map(function (e) { return cst_to_ast_1.cstToAst(e); })) !== null && _b !== void 0 ? _b : []), [].concat.apply([], (_c = classBody === null || classBody === void 0 ? void 0 : classBody.map(function (e) { return cst_to_ast_1.cstToAst(e); })) !== null && _c !== void 0 ? _c : []))
    };
}
exports.run = run;
